...
| Allow insecure HTTPS          | Off            | Disable TLS certificate verification for trusted cameras using a self-signed or otherwise invalid certificate. Requires **Use HTTPS**                                                    |
